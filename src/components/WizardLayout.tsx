    ...
    <div className="flex flex-col h-full wizard-card text-adaptive-primary bg-adaptive-primary">
      ...
      <div className="px-4 sm:px-6 md:px-8 py-6 border-b border-adaptive">
        ...
        <div className="md:hidden">
          <div className="flex justify-between items-center mb-2">            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
              {t('wizard.step', 'Step')} {currentStep + 1} {t('wizard.of', 'of')} {steps.length}
            </span>
